  ...
  return (
    <div className="information-items">
      ...
      <div className="content w-full">
        <Form>
          <div className="grid grid-cols-[1fr,12em] gap-8">
            <div>
        ...
        <div className="w-full mt-12 mb-6">
          <div>
            ...
            <ul className="list-none">
              <li className="flex justify-between flex-wrap border-tertiary border-b-[1px] py-5">
                <div className="text-primary font-bold text-[16px]">
                  Mantener mi información personal oculta
                </div>
                <div className="text-primary font-bold text-[16px]">SI</div>
              </li>
              <li className="flex justify-between flex-wrap py-5">
                <div className="text-primary font-bold text-[16px]">
